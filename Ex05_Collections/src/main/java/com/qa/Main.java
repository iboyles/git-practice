...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        animalMap2.put(d, "overlly excited");
        animalMap2.put(r, "snuffles a lot may have cold");
        animalMap2.put(r2, "may actually be evil");
        System.out.println("foe each loop on animal map values");
        ...
        for (String key : tree.keySet()){
            System.out.println("Key: "+ key+ " Valu: "+ tree.get(key));
        }
